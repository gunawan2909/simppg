...
@section('Dashboard')
    ...
    <div class=" grid grid-cols-1 lg:grid-cols-2 gap-2 mt-10 px-10 mb-10">
                    ...
                    <tr>
                        ...
                        <form action="{{ route('pemeliharaan.penanganan.tool.add', ['id' => $pemeliharaan->id]) }}"
                            ...
                            <td class=" flex justify-center items-center">
                                <button {{ $pemeliharaan->komplain->status == 'Selesai' ? 'disabled' : '' }} type="submit"
                                    class=" input btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        <form action="" method="POST" class="{{ $pemeliharaan->komplain->status == 'Selesai' ? 'hidden' : '' }}">
            @csrf
