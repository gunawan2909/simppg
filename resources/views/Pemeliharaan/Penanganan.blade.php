...
@section('Dashboard')
    ...
    <div class="overflow-x-auto mb-10">
            ...
            <tbody>
                ...
                @foreach ($pemeliharaan as $item)
                    <tr class=" text-center">
                        ...
                        <td>{{ $item->komplain->komponen->name }}</td>
                        <td>{{ $item->komplain->status }}</td>
                        <td>
                            <div class=" flex justify-center space-x-2">
                                <a href="{{ route('pemeliharaan.penanganan.detail', ['id' => $item->id]) }}"
        ...
        <div class=" text-xs flex w-full pl-3  pt-3 border-t ">
            <p>Halaman {{ $pemeliharaan->currentPage() }} Dari {{ $pemeliharaan->lastPage() }} </p>
