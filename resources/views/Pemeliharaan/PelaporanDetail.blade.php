...
@section('Dashboard')
    ...
    <a href="{{ route('pemeliharaan.pelaporan.print', ['id' => $pemeliharaan->id]) }}" class=" btn btn-success ">Unduh
        Laporan<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 15 15">
    ...
    <div class=" grid grid-cols-1 lg:grid-cols-2 gap-2 mt-10 px-10 mb-10">
        ...
        <div class="form-control w-full ">
            <label class="label">
                <span class="label-text">Tanggal Komplain</span>
            </label>
            <input value="{{ $pemeliharaan->komplain->created_at }}" name="komponen_id" disabled
                class="input input-bordered w-full">

        </div>
        <div class="form-control w-full ">
            <label class="label">
                <span class="label-text">Tanggal Pelaksaan</span>
            </label>
            <input value="{{ $pemeliharaan->listkebutuhan[0]->created_at ?? $pemeliharaan->komplain->created_at }}"
                name="komponen_id" disabled class="input input-bordered w-full">
